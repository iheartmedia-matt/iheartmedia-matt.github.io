...
function resizeInit() {
    ...
    $(document).ready(function() {
        ...
        //Set Section 7 Height
        //$('#section7').css('height', (sH-navH/2) + 'px');
        //Set Section 3 Vertical Middle Alignment
        //var s7Height = $('#section7 .container').outerHeight();
        var s7H = sH / 2;
        $('#section7').css('height', s7H + 'px');

        //Set Section 8 Height
        var fH = $('footer').outerHeight();
        var rFH = navH+fH;
        $('#section8').css('height', (sH-rFH) + 'px');
...
function lpFlipper() {
    ...
    $(document).ready(function() {
        function fadeMyContent() {
         $(".lpF:first").fadeIn(500).delay(6000).fadeOut(500,
             function() {    
...
function watchVBtn() {
    ...
    //Video Button
    (function() {
        var triggerBttn = document.getElementById( 'trigger-vid-overlay' ),
...
function modalOverlays() {
    ...
    //Case Study 1
    (function() {
        var triggerBttn = document.getElementById( 'trigger-cs1-overlay' ),
            overlay = document.getElementById( 'cs1-overlay' ),
            closeBttn = overlay.querySelector( 'button.overlay-close' );
...
function scrollSpyInit() {
    ...
    $('body').scrollspy({ target: '#nav', offset: 78 });
    
    console.log('Scroll spy init');
