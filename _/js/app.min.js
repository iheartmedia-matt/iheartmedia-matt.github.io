    ...
    $(function () {
        ...
        function fadeInOut () {
            ...
            headline1.delay(500).queue(function(next) {
                ...
                headline1.delay(5000).queue(function(next) {
                    ...
                    headline2.delay(500).queue(function(next) {
                        ...
                        headline2.delay(5000).queue(function(next) {
                            ...
                            headline3.delay(500).queue(function(next) {
                                ...
                                headline3.delay(5000).queue(function(next) {
...
function videoBG() {
    $(document).ready(function () {
        ...
        $("#section1").vide({
            mp4: 'http://marketing.premierenetworks.com/matt-test/ihr-brand-central/RED.mp4',
            webm: 'http://marketing.premierenetworks.com/matt-test/ihr-brand-central/RED.webm',
            ogv: 'http://marketing.premierenetworks.com/matt-test/ihr-brand-central/RED.ogv',
...
function watchVBtn() {
    ...
    $('#watch-vid-1').on('click', function() {
        ...
        $('#video-container').html('<iframe src="https://player.vimeo.com/video/119911096" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> <p><a href="https://vimeo.com/119911096">ELS Car Video Loop</a> from <a href="https://vimeo.com/user32392391">iHeartMedia</a> on <a href="https://vimeo.com">Vimeo</a>.</p>');
